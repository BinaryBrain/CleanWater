...
#place_label[type='city'][localrank=1][zoom>=7][zoom<10],
#place_label[type='city'][localrank=2][zoom>=9][zoom<11],
#place_label[type='city'][localrank=3][zoom>=11][zoom<12],
#place_label[type='city'][localrank>=4][localrank>9][zoom>=12][zoom<13],
#place_label[type='town'][localrank<=1][zoom>=14][zoom<15] {
  shield-name: @name;
